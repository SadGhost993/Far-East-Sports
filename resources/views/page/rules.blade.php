            ...
            <div class="sports-rules__block">
                <div class="sports-rules__left-side">
                    ...
                    <ul class="peculiarity__list">
                        ...
                        <li class="peculiarity__item">
                            <p class="peculiarity__marker">4</p>
                            <p class="peculiarity__text">присуждаются 2 очка всего 3 раза за тайм, когда у игрока одна
                                нога
            ...
            <div class="sports-rules__block">
                <div class="sports-rules__left-side">
                    ...
                    <ul class="peculiarity__list">
                        <li class="peculiarity__item">
                            <p class="peculiarity__marker">1</p>
                            <p class="peculiarity__text">любые удары руками, кроме: ударов в шею, затылок, позвоночник и
                                по
                                почкам</p></li>
                        <li class="peculiarity__item">
                            <p class="peculiarity__marker">2</p>
                ...
                <div class="sports-rules__right-side sports-rules__right-side--ice-box">
                    ...
                    <div class="sports-rules__right-bottom">
                        ...
                        <ul class="peculiarity__list">
                            <li class="peculiarity__item">
                                <p class="peculiarity__marker">1</p>
                                <p class="peculiarity__text">удары ногами, бить ниже пояса, удары головой, удушающие
                                    действия, удары в пах</p></li>
                            <li class="peculiarity__item">
                                <p class="peculiarity__marker">2</p>
                                <p class="peculiarity__text">борьба, атака упавшего противника, нырки, пассивное ведение
                                    боя, линчевание, укус противника</p></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="sports-rules__block">
                <div class="sports-rules__left-side">
                    ...
                    <ul class="peculiarity__list">
                        ...
                        <li class="peculiarity__item">
                            <p class="peculiarity__marker">5</p>
                            <p class="peculiarity__text">Аут засчитывается при попадании мяча в торец стола, стойки или
                                сетку, при вылете за пределы игровой поверхности</p></li>
                    </ul>
                </div>
                <div class="sports-rules__right-side">
            ...
            <div class="sports-rules__block">
                <div class="sports-rules__left-side">
                    <p class="sports-rules__text">
                        ...
                        Соперничают два игрока или две пары игроков (пары могут быть не только одного пола, но и
                        смешанные
                        — мужчина и женщина)
                    </p>
                    <ul class="peculiarity__list">
                        ...
                        <li class="peculiarity__item">
                            <p class="peculiarity__marker">5</p>
                            <p class="peculiarity__text">При выигрыше принимающим, ему засчитывается очко и он
                                становится новым подающим</p></li>
                    </ul>
                </div>
                <div class="sports-rules__right-side">
            ...
            <div class="sports-rules__block">
                <div class="sports-rules__left-side">
                    ...
                    <ul class="peculiarity__list">
                        <li class="peculiarity__item">
                            <p class="peculiarity__marker">1</p>
                            <p class="peculiarity__text">попадание дротиком в центр дает игроку 50 баллов, в зеленый
                                круг – 25 баллов</p></li>
                        <li class="peculiarity__item">
                            <p class="peculiarity__marker">2</p>
                            <p class="peculiarity__text">попадание в узкий внешний круг мишени удваивает очки
                                сектора</p></li>
                        <li class="peculiarity__item">
                            <p class="peculiarity__marker">3</p>
                            <p class="peculiarity__text">попадание в узкий внутренний круг мишени утраивает очки
                                сектора</p></li>
                        <li class="peculiarity__item">
                            <p class="peculiarity__marker">4</p>
            ...
            <div class="sports-rules__block">
                <div class="sports-rules__left-side">
                    ...
                    <ul class="peculiarity__list">
                        ...
                        <li class="peculiarity__item">
                            <p class="peculiarity__marker">5</p>
                            <p class="peculiarity__text">в случае спорной ситуации - решение определяется видео
                                просмотром</p></li>
                    </ul>
                </div>
                <div class="sports-rules__right-side">
